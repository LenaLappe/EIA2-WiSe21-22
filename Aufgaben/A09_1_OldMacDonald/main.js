...
(function (A09_1) {
    ...
    function createAnimals() {
        cat = new A09_1.Animal("Charlie", "cat", "fish", "miauuuu", 1);
        dog = new A09_1.Animal("Wolfi", "dog", "meat", "wufff", 1);
        horse = new A09_1.Animal("Bella", "horse", "hay", "heyahh", 5);
        cow = new A09_1.Animal("Johann", "cow", "grass", "muhh", 7);
